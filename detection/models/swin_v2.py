...
class SwinTransformer_v2(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(SwinTransformer_v2, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformer_v2, self).train(mode)
        self._freeze_stages()
...
@BACKBONES.register_module()
class swin_v2_tiny(SwinTransformer_v2):
    def __init__(self, **kwargs):
        super(swin_v2_tiny, self).__init__(
            pretrain_img_size=224, in_channels=3, embed_dims=96,
            patch_size=4, window_size=7, mlp_ratio=4, depths=(2, 2, 6, 2),
            num_heads=(3, 6, 12, 24), strides=(4, 2, 2, 2), out_indices=(1, 2, 3),
            ...
            pretrained=None, convert_weights=False, frozen_stages=-1, init_cfg=None
            # init_cfg=dict(
            # type='Pretrained',
            # checkpoint=
